        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="nivel-acesso.cadastro" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Misc">Turmas</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                    ...
                    <div class="d-flex align-items-start row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          {{-- Botões do sistema --}}
                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">Cadastro de Nível de Acesso</a>
